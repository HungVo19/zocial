...
import DatePickerValidate from '../../components/DatePickerValidate';
            ...
            <Box sx={{width: '100%', padding: '10px 20px'}}>
                <AlertMessage
                    ...
                    message={
                        isSuccess ? (
                            ...
                            'Tài khoản này đã bị xóa hoặc không tồn tại'
                        )
                    }
                />
                <PopupConfirm
                ...
                >
                    ...
                    <SelectValidate
                        ...
                        dataSelect={listNation?.data}
                        formData={['countryCode', 'displayName']}
                    />
                    ...
                    <SelectValidate
                        ...
                        autoFocus={shouldFocus}
                    />
                    <Box sx={{ display: 'flex', justifyContent:'space-between', marginLeft:'135px'}}>
                        <Button
                            type='submit'
                            variant='contained'
                            color='primary'
